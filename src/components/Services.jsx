  ...
  const Sel=(num)=>{
    ...
    if (mediaQuery.matches) {
      switch (num) {
        ...
        case 4:
          changebtnimg({...btnimg,[img_set[1]]:red_chaticon,['magnifying_glass']:white_magnifying,['brush']:white_brush,['rejection']:white_rejection,['tablet']:white_tablet});
          imgelement.right = "-5vw";
          imgelement.top = "3vh";
          changeimg(display5);
          break;
    ...
    <div className='services_component' id='Services'>
      ...
      <div className="service_divalign">
        <div className="divbtn">
          <div id='firstbutton' className="dbtn" onClick={()=>{Sel(0)}} onMouseOver={()=>{Sel(0)}}>
            <div id='whitecircle' className="blackcircle"><img src={btnimg.brush} alt="UI/UX" /></div>
